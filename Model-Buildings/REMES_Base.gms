...
* 3 - Techno-Friendly
* 4 - Societal Commitment
* 5 - Directed Transition
...
####################################### ToDo ##################################################################
Heat-pumps update
Look at the "shocks to model sheet" in the CGE data_RVO.xlsx file.
define the percentage
link the percentage with the average yearly applicants for that money
compute the total payment (divide the yearly payments in excel with the total applicants to get the payment per applicant)
include the extra energy savings depending on the number of applicants
define the subsidy from the government as a constraint to the CGE model.


Buildings update
include the percentage (for restructurations - this is used to define an upfront payment in Million Euros to be given to households as a subsidy to purchase pCON)
include the relation with total payment to be granted to households (for the constraint to define the subsidy)
include the relation with the improvement in efficiency (for gas - The improvement cumulates over time)
in MPSGE - include new subsidy.
           apply the subsidy on purchases of pCON
           define a constraint for the definition of the subsidy.
$offtext
...
scalar ISDEhp percentage subsidy for heat-pumps to consumers                                                                     /0/;
scalar ISDEb  percentage subsidy for buildings to consumers                                                                      /0/;
scalar bridging if set to 1 (case30) 2 (case50) or 3 (case92) overrides payb and takes it from external data                     /3/;
$endif
...
scalar EF   if set to 1 we consider energy intensity effects                                                                     /1/;
scalar CF   if set to 1 we consider carbon intensity effects                                                                     /1/;
scalar PG   productivity growth for labour 0 if notbridgi accounted                                                              /1/;
scalar prdR productivity increase factor after the benchmark for power and h2 sector                                             /0/;
...
scalar ExEff Extra energy efficiency                                                                                             /0/;
scalar ISDEhp percentage subsidy for heat-pumps to consumers                                                                     /0/;
scalar ISDEb  percentage subsidy for buildings to consumers                                                                      /0.92/;
scalar bridging if set to 1 (case30) 2 (case50) or 3 (case92) overrides payb and takes it from external data                     /3/;
$endif
* With bridging, set ISDEb to 0.3, 0.5, or 0.92, set bridging parameter to 1, 2, or 3,
* and change the values in parameters extpay30, extpay50, and extpay92

$ifthen %CaseStudy%==2
scalar P_S if equal to 1 base case without considering external shares and cut of resources                                      /2/;
scalar carbonbudget By default is low (reduce 90% but it can be left at reducing by 40% by multiplying by 4) high=4 low=1        /0.18/;
scalar GHGred if 1 we control the emissions if 0 we do not use a cap                                                             /1/;
scalar tariff This works on tariffs on energy import from Visegrad countries                                                     /0/;
scalar coop this works on the CO2 budget for Visegrad countries                                                                  /1/;
scalar rescut cut of fossil resources per period                                                                                 /0.84/;
scalar CUT  if set to 1 we cut resources by rescut otherwise we do not                                                           /1/;
scalar GDPt if set to 1 then we test a case with no GDP growth                                                                   /1/;
...
scalar CF   if set to 1 we consider carbon intensity effects                                                                     /1/;
scalar PG   productivity growth for labour 0 if not accounted                                                                    /1/;
scalar prdR productivity increase factor after the benchmark for power and h2 sector                                             /0.02/;
scalar ROWgr growth of the Rest Of the World                                                                                     /1/;
scalar ES external shares 1 if external shares are used for power 0 otherwise                                                    /1/;
scalar ROWco coal export to rest of the world                                                                                    /1/;
scalar CCE climate change effects                                                                                                /1/;
scalar GSus green subsidy                                                                                                        /0/;
scalar ExEff Extra energy efficiency                                                                                             /0/;
scalar ISDEhp percentage subsidy for heat-pumps to consumers                                                                     /0.2/;
scalar ISDEb  percentage subsidy for buildings to consumers                                                                      /0/;
scalar bridging if set to 1 (case30) 2 (case50) or 3 (case92) overrides payb and takes it from external data                     /0/;
$endif


$ifthen %CaseStudy%==3
scalar P_S if equal to 1 base case without considering external shares and cut of resources                                      /3/;
scalar carbonbudget By default is low (reduce 90% but it can be left at reducing by 40% by multiplying by 4) high=4 low=1        /0.047/;
scalar GHGred if 1 we control the emissions if 0 we do not use a cap                                                             /1/;
scalar tariff This works on tariffs on energy import from Visegrad countries                                                     /0/;
scalar coop this works on the CO2 budget for Visegrad countries                                                                  /1/;
scalar rescut cut of fossil resources per period                                                                                 /0.84/;
...
scalar CCE climate change effects                                                                                                /1/;
scalar GSus green subsidy                                                                                                        /0/;
scalar ExEff Extra energy efficiency                                                                                             /1/;
scalar ISDEhp percentage subsidy for heat-pumps to consumers                                                                     /0.2/;
scalar ISDEb  percentage subsidy for buildings to consumers                                                                      /0/;
scalar bridging if set to 1 (case30) 2 (case50) or 3 (case92) overrides payb and takes it from external data                     /0/;
$endif
...
$ifthen %CaseStudy%==4
scalar P_S if equal to 1 base case without considering external shares and cut of resources                                      /4/;
scalar carbonbudget By default is low (reduce 90% but it can be left at reducing by 40% by multiplying by 4) high=4 low=1        /0.08/;
scalar GHGred if 1 we control the emissions if 0 we do not use a cap                                                             /1/;
scalar tariff This works on tariffs on energy import from Visegrad countries                                                     /0/;
scalar coop this works on the CO2 budget for Visegrad countries                                                                  /1/;
scalar rescut cut of fossil resources per period                                                                                 /0.84/;
...
$ifthen %CaseStudy%==5
scalar P_S if equal to 1 base case without considering external shares and cut of resources                                      /5/;
scalar carbonbudget By default is low (reduce 90% but it can be left at reducing by 40% by multiplying by 4) high=4 low=1        /0.08/;
scalar GHGred if 1 we control the emissions if 0 we do not use a cap                                                             /1/;
scalar tariff This works on tariffs on energy import from Visegrad countries                                                     /0/;
scalar coop this works on the CO2 budget for Visegrad countries                                                                  /1/;
...
$ifthen %CaseStudy%==3
$call gdxxrw.exe oePathwayTF.xlsx par=PrimaryEnergy rng=Sheet1!A1:G5915 cdim=1 rdim=6
$endif

$ifthen %CaseStudy%==4
$call gdxxrw.exe oePathwaySC.xlsx par=PrimaryEnergy rng=Sheet1!A1:G5915 cdim=1 rdim=6
$endif

$ifthen %CaseStudy%==5
$call gdxxrw.exe oePathwayDT.xlsx par=PrimaryEnergy rng=Sheet1!A1:G5915 cdim=1 rdim=6
$endif
...
$gdxin oePathwayDT.gdx
$load PrimaryEnergy
$gdxin

SelEnet(countries,source1,year)=
PrimaryEnergy('GENeSYS-MOD2.9','DirectedTransition1.0',countries,source1,'EJ/yr',year,'value');
ConsEneIndt(countries,source2,year)=
PrimaryEnergy('GENeSYS-MOD2.9','DirectedTransition1.0',countries,source2,'EJ/yr',year,'value');
ConsEneTrat(countries,source3,year)=
PrimaryEnergy('GENeSYS-MOD2.9','DirectedTransition1.0',countries,source3,'EJ/yr',year,'value');
ConsEneSHt(countries,source4,year)=
PrimaryEnergy('GENeSYS-MOD2.9','DirectedTransition1.0',countries,source4,'EJ/yr',year,'value');
$endif
...
* Techno-Friendly
set linkSor(source1,*)/
* where is COAL and OIL?
'SecondaryEnergy|Electricity|Biomass|w/CCS'.pBIO
'SecondaryEnergy|Electricity|Biomass|w/oCCS'.pBIO
'SecondaryEnergy|Electricity|Gas|w/CCS'.pNG
'SecondaryEnergy|Electricity|Gas|w/oCCS'.pNG
'SecondaryEnergy|Electricity|Geothermal'.pNG
'SecondaryEnergy|Electricity|Hydro'.K
'SecondaryEnergy|Electricity|Nuclear'.K
'SecondaryEnergy|Electricity|Other'.K
'SecondaryEnergy|Electricity|Solar|PV'.K
'SecondaryEnergy|Electricity|Wind|Offshore'.K
'SecondaryEnergy|Electricity|Wind|Onshore'.K
/;
...
*##################### ISDE for heat pumps Initialization ###############################

Parameter Tapp Total applicants for ISDEhp for five years;
* 1 link the percentage to the total amount of applicants per year
Tapp=0;
Tapp$(ISDEhp)=(-49321.5+285221.6667*ISDEhp)*5;

* The next parameter needs to be linked to the percentage offered.
* if the payment is computed assuming a 20% subsidy then we need to compute the monetary subsidt corresponding to a 1% subsidy.
*parameter ppa payment per applicant;
parameter mpp monetary payment per percent subsidy rate (this is to be multiplied by the number of applicants and the percentage offered);
mpp=0;
mpp$(ISDEhp)=88.5843;
* The next parameter depends on the number of applicants and the reduction per single applicant
parameter Ers Energy reduction in percentage (ONLY for buildings) as a consequence of heat pumps installation per applicant;
parameter Ered total energy reduction in percentage (all the households - depends on the number of applicants) in 5 years - assuming linear adoption over time;
Ered=0;
Ered$(ISDEhp)=(-0.004582687+0.027004577*ISDEhp)*5;
* in this case (for buildings) I make the reduction of energy consumption
* only if the payment to households is positive
Ered$(-6975870.965+4560091.264*100*ISDEb gt 0)= 0.000195429*100*ISDEb*5;

parameter pay Payment to households - payment per applicant multiplied by number of applicants;
pay=0;

parameter extpay30(step)/
1        0
2        0
3        0
4        0
...
parameter ER energy reduction to be used in the model (recoursive);
ER=0;

display Tapp,Ered pay;


parameter payb payment to households for buildings;
payb=0;
...
ER=1-(1-ER)*(1-Ered);
ER$(ER ge 0.25)=0.25;
*pay = percentage coverage X euro per percent coverage X number of applicants
pay$(ISDEhp)=ISDEhp*100*mpp*Tapp/1000000;
* this is the payment for buildings in Million Euros for 5 years
payb$(-6975870.965+4560091.264*100*ISDEb gt 0)=(-6975870.965+4560091.264*100*ISDEb)/1000000*5;

* if bridging is active the payb comes from the external payment data from AMT
payb$(bridging eq 1)=extpay30(step);
payb$(bridging eq 2)=extpay50(step);
payb$(bridging eq 3)=extpay92(step);
...
execute_unload 'applied counterfactuals.gdx' PRC,apptc,apptp,pathway_adj,prdR,InputCom,TOGR,TCR,TNGR,gdp_p,eint,cint,Pathway_adj_cap,KZ,open,CO2B,taxcz,taxpz,ER,pay,payb;

execute_unload 'TestTNO' outAct,CO2Pr,gdptest,TotCons,PriceIndex,outLab,outPrice,outWages,outKap,gdp,PriceCO2;

parameter demcal(cnt,com),NLHdem;
demcal(cnt,com)=0;
demcal('NL','pIND')=(CZ('NL','pIND') + Pathway_adj('NL', "HOUS", 'pIND'))*(1+taxcz('NL', 'pIND'))/(P.l('NL', 'pIND')*(1+taxc('NL', 'pIND'))*(1-ISDEs.l('NL', 'pIND')))*PU.l('NL')*U.L('NL');

*demcal('NL','pIND')=(CZ('NL','pIND') + Pathway_adj('NL', "HOUS", 'pIND'))*(1-ISDEs.l('NL','pIND'))/P.l('NL', 'pIND')*PU.l('NL')*U.L('NL');
NLHdem=HOUS_DEM.l('NL','pIND');

parameter demser(cnt,sec,com),NLSdem,CC1;
demser(cnt,sec,com)=0;
CC1=sum(com,PD.l('NL','iSER',com)*XDDZ('NL','iSER',com))/XDZ('NL','iSER')*(1-taxp('NL','iSER'))/(1-taxpz('NL','iSER'));
demser('NL','iSER','pIND')=((CC1*(1+taxcz('NL','pIND'))/(P.l('NL','pIND')*(1+taxc('NL','pIND'))))**ELAS('iSER', "KLEM"))*(IOZ('NL','pIND','iSER')+Pathway_adj('NL', 'iSER', 'pIND'))*XD.l('NL','iSER');
NLSdem=REP_SEC_IN.l('NL','iSER','pIND');


* Final output
execute_unload "outputREMES.gdx" outAct,GDPout,VA,UNEMPLOYMENT,IOanalysis,SAM,SAMout,PPP,Quantity,PriceCO2,gdptest,gdp,EEdem,qKLEM,pKLEM,fKLEM,EUIMP,EUEXP,demcal,NLHdem,Tapp,ER,pay,payb,demser,NLSdem,CC1;
